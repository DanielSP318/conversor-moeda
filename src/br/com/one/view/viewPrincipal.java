package br.com.one.view;

import javax.swing.JOptionPane;

import br.com.one.conversorMoedas.Funcao;
import br.com.one.converteTemperatura.FuncaoTemperatura;
...
public class viewPrincipal {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			String opcao = JOptionPane.showInputDialog(null, "Escolha um conversor", "Menu", JOptionPane.PLAIN_MESSAGE,
